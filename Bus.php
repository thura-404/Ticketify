<?php
	...
	if (isset($_POST['btnSave']))
	{
        ...
        if (Insert_Data("Bus",
                        "(ID, Type, Capacity, SPR)",
                        "('$ID', '$Name', '$Capacity', '$SPR')"))
        {
            echo "<script>window.alert('Bus Successfully Saved.')</script>";
            echo "<script>window.location='Bus.php'</script>";
        }
        else
        {
            ...
            <div class="Item">
                ...
                ?>
                    ...
                    <?php 
                        ...
                        if (isset($_REQUEST['Update'])) 
                        {
                            $Rows		= mysqli_fetch_array(Multi_Select("*","Bus","ID",$_SESSION['Update']));
                        }
                        else
                        {
                    ?>
                        ...
                        <div class="Input_Field">
                            ...
                            <input type="text" name="txtType" class="Input" required />								
                        </div>	

                        <div class="Input_Field">
                            <label>Capacity</label>

                            <input type="text" name="txtCapacity" class="Input" required />								
                        </div>	

                        <div class="Input_Field">
                            <label>Seats Per Rows</label>

                            <input type="text" name="txtSPR" class="Input" required />								
                        </div>	
                                ...
                                { 
                                    ...
                                    if (isset($_REQUEST['Update'])) 
                                    {
                                        ...
                                        if ($ID == $_SESSION['Update']) 
                                        {
                                            ...
                                            echo("<td>
                                                    <a href='Bus.php?Delete=$ID'><i class='far fa-trash-alt'></i></a>
                                                </td>");
                                            echo "</tr>";
                                        }
                                        else
                        ...
                        <tbody>
                            ...
                            <?php 
                                ...
                                { 
                                    ...
                                    echo("<td>" . $rows["Capacity"] . "</td>");
                                    echo("<td>
                                            <a href='Bus.php?Delete=$ID' class='Link'>
